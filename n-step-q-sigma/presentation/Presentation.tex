...
\begin{frame}
  ...
  % TODO: Obtain plot using the implementations and Stochastic Windy Gridworld
...
\begin{frame}
  \frametitle{Synopsis}
  % TODO: Do a better job at summarizing the results: repeat what has been said
  % today, what important results and intuition is obtained through the sequence
  % of transitions, etc.
  \begin{itemize}
